<?php
    ...
    if (isset($_POST['forget-email'])){
        $email = htmlspecialchars($_POST['forget-email']);
        ...
        if (!empty($email)){
            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                if ($result){
                    ...
                    $content = "Veuillez réinitialiser 
                                    votre mot de passe en cliquant sur <a href='http://".$host."/saisir-mot-de-passe.php?token=".$token."'>Réinitiliser</a>";
                    ;
