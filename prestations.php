...
<body>
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="row"><h2 class="text-center">NOS COURS</h2></div>
            <br>
            <div class="row mt-3">
                ...
                <div class="card mr-2 mb-2" style="width: 16rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text text-center" style="color: red; font-weight: bold;"><?=ucfirst($data['categorie']);?></p>
                        <p class="card-text text-center"><?=ucfirst($data['jour']);?></p>
                        <p class="card-text text-center"><?=$data['debut'].' - '.$data['fin'];?></p>
                    </div>
                    <div class="card-footer text-center">
                        <a href="reserver.php?prestation=<?=$data['slug'];?>" class="card-link btn btn-primary">Reserver</a>
                    </div>
                </div>
                <?php }?>
            </div>
